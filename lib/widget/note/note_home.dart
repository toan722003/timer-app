...
class _NoteHomeWidgetState extends State<NoteHomeWidget> {
  final List<CalendarEventData<Event>> _events = [
    ...
    CalendarEventData(
        title: "Study English",
        date: getNow,
        startTime: DateTime(2022, 11, 23, 9, 30),
        endTime: DateTime(2022, 11, 23, 10, 30),
        endDate: getNow.subtract(const Duration(days: 1)),
    ...
    CalendarEventData(
        ...
        endTime: DateTime(2022, 11, 23, 19, 30),
        endDate: getNow.subtract(const Duration(days: 1)),
    ...
    CalendarEventData(
        ...
        color: UIColor.green,
        date: getNow,
        startTime: DateTime(2022, 11, 23, 14, 30),
        endTime: DateTime(2022, 11, 23, 15, 30),
        endDate: getNow.subtract(const Duration(days: 1)),
        event: Event(title: "quite5")),
    CalendarEventData(
        title: "Learn Programming",
        color: UIColor.green,
        date: getNow,
        startTime: DateTime(2022, 11, 23, 20, 30),
        endTime: DateTime(2022, 11, 23, 23, 30),
        endDate: getNow.subtract(const Duration(days: 1)),
        event: Event(title: "quite5")),
  ];
